...
| `registerAgentTask` / `ExtensionAgentTaskContribution` | Yes | Yes | Daemon contribution manifest projection; contribution-reference start shape parses, execution is not wired yet |
