...
name: Move eforge-plan mutation paths to SQLite repositories while keeping
  session-plan Markdown as build artifacts and centralizing duplicate planning
  suppression.
