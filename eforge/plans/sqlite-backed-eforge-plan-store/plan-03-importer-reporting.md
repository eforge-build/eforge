...
name: Implement dry-run-first, idempotent legacy importer/reporting for existing
  Markdown, JSON sidecars, session plans, traces, queue/build/session/landing
