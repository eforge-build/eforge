...
name: Integrate Console into monitor packaging and static serving at /console/,
  add side-by-side navigation links, build scripts/dependencies, server tests,
  and modest docs.
