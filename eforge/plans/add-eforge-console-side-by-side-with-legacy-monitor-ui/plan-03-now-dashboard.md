...
name: Implement the Now dashboard with daemon status, scheduler/auto-build
  summary, queue depth, concurrent active build cards, attention items, stack
  summary, and recent activity preview.
