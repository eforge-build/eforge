...
name: Wire the final router and stream hub in server.ts, preserve compatibility
  exports, trim server.ts, add registry/security/static/compatibility coverage,
  and satisfy maintainability marker gates.
