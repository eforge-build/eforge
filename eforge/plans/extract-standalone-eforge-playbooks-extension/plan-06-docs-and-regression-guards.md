...
name: Update user/reference docs and add final boundary, planning-dependency,
  extension-unavailable, package-registration, and cross-host regression guards.
