...
name: Remove the core Console Playbooks System section and rely on
  eforge-playbooks extension Console contributions or workstation entries for
  playbook management.
