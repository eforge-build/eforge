...
import { AMBIGUOUS_SHIPPED_EVIDENCE_PREFIX, AMBIGUOUS_SUPERSEDED_EVIDENCE_PREFIX, SHIPPED_GIT_PR_EVIDENCE_PREFIX, SHIPPED_LIFECYCLE_EVIDENCE_PREFIX, SUPERSEDED_GIT_PR_EVIDENCE_PREFIX, SUPERSEDED_LIFECYCLE_EVIDENCE_PREFIX, validateClosedStatusEvidencePrefix } from '../backlog-curation-evidence-prefixes.js';
...
describe('backlog curation evidence prefixes', () => {
  ...
  it('rejects opposite, ambiguous, missing, and blank evidence for closed statuses', () => {
