...
export default defineEforgeExtension((eforge) => {
  ...
  eforge.registerConsoleContribution(defineConsoleContribution({
    ...
    blocks: [
      ...
      { rendererId: 'action-form', title: 'Resubmit session plan', content: 'Recover a submitted session plan after terminal failed or removed queue/build evidence without deleting or recreating it.', action: { actionId: 'resubmit-session-plan' } },
