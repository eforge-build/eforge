...
interface Props { plan: PlanData; api: PlanRevisionSessionApi; rail?: boolean }

export function PlanRevisionPanel({ plan, api, rail = false }: Props) {
