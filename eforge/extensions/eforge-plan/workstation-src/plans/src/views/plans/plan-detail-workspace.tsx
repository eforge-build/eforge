...
export function PlanDetailWorkspace({ detail, artifact, titles, onApply, onRefresh, onDeleted }: PlanDetailWorkspaceProps) {
  ...
  return (
    <>
      <section className="min-w-0">
        <PlanDetailCard detail={detail} revision={revision} locked={revision.hasRunningTurn} onSelectAnnotationTarget={setPendingAnnotationTarget} onApply={onApply} onRefresh={onRefresh} onDeleted={onDeleted} />
      </section>
