...
export function BacklogCurationPreview({ taskId, entry, draft, recommendations, curationPreview, busy, onApply, onRedraft }: BacklogCurationPreviewProps) {
  ...
  const hasReviewContent = draft.summary.length > 0 || draft.itemChanges.length > 0 || draft.epicChanges.length > 0 || draft.noOpRechecks.length > 0 || draft.skipped.length > 0 || draft.needsInput.length > 0 || Boolean(displayRecommendations);
