...
export interface ProjectionItemRow { id: string; title: string; body: string; userStatus: UserStatus; priority?: string; source?: string; createdAt?: string; updatedAt?: string; epicId?: string; frontmatter: Record<string, unknown>; tags: string[] }
