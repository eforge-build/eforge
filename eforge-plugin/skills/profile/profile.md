...
Call the `mcp__eforge__eforge_profile` tool with `{ action: "show" }`.
...
| `mcp__eforge__eforge_extension_contribution` | User wants to discover or invoke workflows provided by loaded extensions |
