...
export const handlerRegistry = {
  ...
  'plan:build:recovery:start': handlePlanBuildRecoveryStart,
  'plan:build:recovery:attempt:start': handlePlanBuildRecoveryAttemptStart,
  'plan:build:recovery:attempt:result': handlePlanBuildRecoveryAttemptResult,
  'plan:build:recovery:skip': handlePlanBuildRecoverySkip,
  'plan:build:recovery:exhausted': handlePlanBuildRecoveryExhausted,
...
export const IGNORED_EVENT_TYPES = [
  ...
  'stack:sync:deferred',
  'stack:sync:skipped',
  // Direct PR base-sync lifecycle events are progress-only for run display.
  'base-sync:start',
