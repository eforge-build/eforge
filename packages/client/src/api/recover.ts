...
export function apiRecoverIfRunning(opts: { cwd: string; body: RecoverRequest }) {
  return daemonRequestIfRunning<RecoverResponse>(opts.cwd, 'POST', API_ROUTES.recover, opts.body);
}
