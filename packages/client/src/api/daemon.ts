...
export function apiStopDaemonIfRunning(opts: { cwd: string; body?: StopDaemonRequest }) {
  return daemonRequestIfRunning<StopDaemonResponse>(opts.cwd, 'POST', API_ROUTES.daemonStop, opts.body);
}
