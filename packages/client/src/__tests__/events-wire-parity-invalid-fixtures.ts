...
export const wrongLiteralPayloads: InvalidEventWireParityFixture[] = [
  ...
  { label: 'agent:start with invalid harness value', payload: { type: 'agent:start', timestamp: '2025-01-01T00:00:00.000Z', agentId: 'agent-1', agent: 'builder', model: 'claude-sonnet-4-5', harness: 'unknown-harness', harnessSource: 'tier', tier: 'standard', tierSource: 'tier', runtimeChoice: 'default', runtimeChoiceQualified: 'standard.default', runtimeChoiceSource: 'default' }, expectedErrorPath: '' },
  ...
  { label: 'queue:prd:dispatch-failed with invalid stage literal', payload: { type: 'queue:prd:dispatch-failed', timestamp: '2025-01-01T00:00:00.000Z', prdId: 'prd-1', title: 'PRD 1', reason: 'blocked', stage: 'unknown-stage' }, expectedErrorPath: '' },
