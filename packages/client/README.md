...
- **Request/response types** - TypeScript interfaces and TypeBox schemas for daemon HTTP endpoints, including extension contribution manifest, action invocation, and daemon-owned agent-task contracts
