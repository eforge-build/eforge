...
```
<review-issues>
  <issue issueId="optional-hint-1" severity="critical|warning|suggestion" category="injection|secrets|auth|unsafe-ops|cryptography|dependencies|data-exposure" file="path/to/file.ts" line="42">
