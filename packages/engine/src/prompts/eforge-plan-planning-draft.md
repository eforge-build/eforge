...
- In source-first implementation audit mode, keep `epicChanges: []`; source-first preview metadata is item-scoped. Route epic-level uncertainty or proposed changes through `needsInput`, `skipped`, or a later delta curation pass.
