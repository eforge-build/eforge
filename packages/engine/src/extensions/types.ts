...
export type ConsoleWorkstationSpec =
  | { id: string; title: string; description?: string; srcDoc: string; frameBundle?: never; allowedActions?: string[] }
  | { id: string; title: string; description?: string; srcDoc?: never; frameBundle: ConsoleWorkstationFrameBundleSpec; allowedActions?: string[] };
