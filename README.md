...
**Workflow profiles** - Before agent planning, eforge runs a deterministic preflight over the normalized source. It keeps the full source for provenance and validation, but may compact generated or machine-readable bulk before inserting it into composer/planner prompts. The planner then assesses complexity and selects a profile:
